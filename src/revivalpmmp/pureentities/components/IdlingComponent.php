...
class IdlingComponent {
    ...
    public function checkAndSetIdling(): bool {
        ...
        if (!$this->idling and // of course it should not idle currently
            ($this->baseEntity instanceof IntfCanBreed and $this->baseEntity->getBreedingComponent() !== null && $this->baseEntity->getBreedingComponent()->getInLove() <= 0) and // do not rest while in love!
